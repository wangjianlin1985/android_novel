	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_novelObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionComment.setNovelObj(novelList.get(arg2-1).getNovelId()); 
				else
					queryConditionComment.setNovelObj(0);
			}
			@Override
		...
		spinner_userObj.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionComment.setUserObj(userInfoList.get(arg2-1).getUser_name()); 
				else
					queryConditionComment.setUserObj("");
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*获取查询参数*/
					queryConditionComment.setContent(ET_content.getText().toString());
					queryConditionComment.setCommentTime(ET_commentTime.getText().toString());
