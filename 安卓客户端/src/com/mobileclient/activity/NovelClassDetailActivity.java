...
public class NovelClassDetailActivity extends Activity {
	// 声明返回按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.novelclass_detail);
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("查看小说类别详情");
		...
		btnReturn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				NovelClassDetailActivity.this.finish();
			}
		}); 
		initViewData();
	}
	...
	private void initViewData() {
		...
		this.TV_classId.setText(novelClass.getClassId() + "");
		this.TV_className.setText(novelClass.getClassName());
	} 
}
