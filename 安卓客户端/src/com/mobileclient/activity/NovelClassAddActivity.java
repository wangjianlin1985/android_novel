...
public class NovelClassAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.novelclass_add); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("添加小说类别");
			...
			public void onClick(View v) {
				try {
					...
					if(ET_className.getText().toString().equals("")) {
						Toast.makeText(NovelClassAddActivity.this, "分类名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传小说类别信息*/
					NovelClassAddActivity.this.setTitle("正在上传小说类别信息，稍等...");
					String result = novelClassService.AddNovelClass(novelClass);
