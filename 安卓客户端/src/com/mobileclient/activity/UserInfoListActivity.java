				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","name","sex","userPhoto","birthday","telephone" },
	        					new int[] { R.id.tv_user_name,R.id.tv_name,R.id.tv_sex,R.id.iv_userPhoto,R.id.tv_birthday,R.id.tv_telephone,},lv);
