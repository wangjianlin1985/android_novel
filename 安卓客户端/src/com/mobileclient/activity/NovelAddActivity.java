...
public class NovelAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iv_novelPhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(NovelAddActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_novelName.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "小说名称输入不能为空!", Toast.LENGTH_LONG).show();
						ET_novelName.setFocusable(true);
						ET_novelName.requestFocus();
						return;	
					}
					novel.setNovelName(ET_novelName.getText().toString());
					if(novel.getNovelPhoto() != null) {
						//如果图片地址不为空，说明用户选择了图片，这时需要连接服务器上传图片
						NovelAddActivity.this.setTitle("正在上传图片，稍等...");
						String novelPhoto = HttpUtil.uploadFile(novel.getNovelPhoto());
						NovelAddActivity.this.setTitle("图片上传完毕！");
						novel.setNovelPhoto(novelPhoto);
					} else {
						novel.setNovelPhoto("upload/noimage.jpg");
					}
					/*验证获取作者*/ 
					if(ET_author.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "作者输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_publish.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "出版社输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_novelPageNum.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "页数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(novel.getNovelFile() != null) {
						...
						novel.setNovelFile("upload/noimage.jpg");
					}
					/*验证获取是否推荐*/ 
					if(ET_tjFlag.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "是否推荐输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_readCount.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "阅读量输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_novelDesc.getText().toString().equals("")) {
						Toast.makeText(NovelAddActivity.this, "小说简介输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传小说信息*/
					NovelAddActivity.this.setTitle("正在上传小说信息，稍等...");
