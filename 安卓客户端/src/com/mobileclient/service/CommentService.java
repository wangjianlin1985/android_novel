...
public class CommentService {
	...
	public String AddComment(Comment comment) {
		...
		params.put("novelObj", comment.getNovelObj() + "");
		params.put("content", comment.getContent());
		params.put("userObj", comment.getUserObj());
	...
	public List<Comment> QueryComment(Comment queryConditionComment) throws Exception {
		...
		if(queryConditionComment != null) {
			urlString += "&novelObj=" + queryConditionComment.getNovelObj();
			urlString += "&content=" + URLEncoder.encode(queryConditionComment.getContent(), "UTF-8") + "";
			urlString += "&userObj=" + URLEncoder.encode(queryConditionComment.getUserObj(), "UTF-8") + "";
			urlString += "&commentTime=" + URLEncoder.encode(queryConditionComment.getCommentTime(), "UTF-8") + "";
		}
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				comment.setNovelObj(object.getInt("novelObj"));
				comment.setContent(object.getString("content"));
				comment.setUserObj(object.getString("userObj"));
