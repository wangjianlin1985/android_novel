...
public class NovelClassAction extends BaseAction {
    ...
    public String AddNovelClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("NovelClass添加成功!"));
            return "add_success";
            ...
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("NovelClass添加失败!"));
            return "error";
        }
    }
    ...
    public String QueryNovelClassOutputToExcel() { 
		...
		*/
		...
		try { 
			...
			response.setHeader("Content-disposition","attachment; filename="+"NovelClass.xls");//filename是下载的xls的名，建议最好用英文 
    ...
    public String ModifyNovelClass() {
        ...
        try {
            ...
            ctx.put("message",  java.net.URLEncoder.encode("NovelClass信息更新成功!"));
            return "modify_success";
        } catch (Exception e) {
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("NovelClass信息更新失败!"));
            return "error";
       }
   }
    ...
    public String DeleteNovelClass() {
        ...
        try { 
            ...
            ctx.put("message",  java.net.URLEncoder.encode("NovelClass删除成功!"));
            return "delete_success";
        } catch (Exception e) { 
            e.printStackTrace();
            ctx.put("error",  java.net.URLEncoder.encode("NovelClass删除失败!"));
            return "error";
        }
    }
